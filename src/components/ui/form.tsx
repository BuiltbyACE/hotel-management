...
// shadcn/ui "form" — React Hook Form wrapper.
// The base (Base UI) registry no longer ships this component, so it is vendored
// directly. It depends only on react-hook-form + cn + React.
